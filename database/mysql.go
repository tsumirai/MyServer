...
func InitMysql() {
	...
	if err != nil {
		logger.Error(context.TODO(), "InitMysql", logger.LogArgs{"msg": "InitMysql failed", "err": err.Error()})
		panic(err)
	}

	logger.Info(context.TODO(), "InitMysql", logger.LogArgs{"msg": "InitMysql Success!"})
}
